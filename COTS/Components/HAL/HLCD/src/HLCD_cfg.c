...
/*[HLCD_LCD2] = {
    .HLCD_strLCDPins = {
        .HLCD_PIN_D0 = HLCD_PINC0,  // Data pin D0 connected to Port C, Pin 0
        .HLCD_PIN_D1 = HLCD_PINC1,  // Data pin D1 connected to Port C, Pin 1
        .HLCD_PIN_D2 = HLCD_PINC2,  // Data pin D2 connected to Port C, Pin 2
        .HLCD_PIN_D3 = HLCD_PINC3,  // Data pin D3 connected to Port C, Pin 3
    ...
    .HLCD_strFunctionSet = {
        .HLCD_enuCharacterFont = HLCD_enuCharacterFont_5x7,  // 5x7 font
